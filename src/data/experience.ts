...
export const experiences: Experience[] = [
  {
    ...
    startDate: 'Sep 2025',
    endDate: 'Nov 2025',
    description: 'B2B2C healthcare platform enabling physician practices to bill CMS (Medicare) for APCM care management services.',
    highlights: [
      'Built multi-agent LLM system for clinical workflow automation across Epic, Cerner, and Athena EMRs',
      'Designed retention-focused growth strategy where patient engagement = billable revenue for practices',
      'Created strategic framework (Desires → Goals → Problems → Solutions → Impact) for prioritization',
      'Coordinated multi-stakeholder product: patients, providers, payers, care managers, CMS compliance',
      'Contract ended when startup ran out of runway',
    ],
    tech: ['Multi-Agent AI', 'LLM', 'Healthcare', 'EMR Integration', 'CMS Compliance', 'B2B2C'],
  },
  {
    id: 'zenbusiness',
    company: 'ZenBusiness',
